...
def fetch_top_gainers_losers(period_days):
    ...
    if results:
        top_gainers = results[:5]  # Top 10 gainers
        top_losers = results[-5:]  # Top 10 losers
...
def get_database_connection():
    return sqlite3.connect('/home/sigmoid/Desktop/TechDemo_final/StockMarketApp-main/db.sqlite3')
...
def store_data(data, symbol):
    ...
    # print(f"Complete data for {symbol}:")
...
def main():
    symbols = ["AAPL", "GOOGL", "MSFT", "AMZN", "META", "TSLA", "NFLX", "NVDA", "BABA", "JPM"]  # List of 10 stock symbols to fetch data for
